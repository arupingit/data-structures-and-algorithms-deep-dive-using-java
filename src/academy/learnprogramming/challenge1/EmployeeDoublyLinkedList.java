...
public class EmployeeDoublyLinkedList {
    ...
    public boolean addBefore(Employee newEmployee, Employee existingEmployee) {
    	...
    	while(currentNode!=null && currentNode.getEmployee() != existingEmployee){
    	...
    	if(head == currentNode){
    		...
    		currentNode.getPrevious().setNext(newEmployeeNode);
    		newEmployeeNode.setPrevious(currentNode.getPrevious());
    		currentNode.setPrevious(newEmployeeNode);
    		size++;
    		return true;
    	}
